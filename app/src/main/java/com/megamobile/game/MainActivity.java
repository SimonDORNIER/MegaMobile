...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT); immersive();
        gameView = new GameViewPro(this); setContentView(gameView); UpdateManager.checkAndUpdate(this);
    }
    ...
    @Override protected void onResume(){super.onResume();immersive();UpdateManager.tryInstallPending(this);if(gameView!=null)gameView.resumeGame();}
